class AirdropLogs:
    ...
    INVITED_PERFORMACE_TERMS = (
        "✅ Условия выполнены! ✅\n\n"
        "↘️ <b>Пригласитель:</b> ID{inviter_id} | {inviter_email} | {inviter_plan}\n"
        "↖️ <b>Приглашенный:</b> ID{invitee_id} | {invitee_email}\n\n"
    ...
    NEW_INVITER = (
        "🔰 Новый Пригласитель 🔰\n\n"
        "👤 <b>Пользователь:</b> ID{invitee_id} | {invitee_email}\n\n"
        "🔰 Условия AirDrop: ✅\n"
    ...
    INVITER_CHANGE_PLAN = (
        ...
        "👤 <b>Пользователь:</b> ID{invitee_id} | {invitee_email}\n\n"
        "📈 Изменения:\n"
        "🔰 <b>Новый тариф:</b> {new_plan}\n\n"
        "📊 <b>Эффект:</b> Бонус изменен на {amount} KOLLLABIUM"
    )
